...
git_host_list="github.com.cnpmjs.org"
git_host=github.com.cnpmjs.org
branch=""
...
get_git_branchs() {
  ...
  [ "$branchs" = "" ] && git_host=github.com.cnpmjs.org && branchs="$(git ls-remote --heads https://$git_host$git_op_uri|awk -F '/' '{print $NF}'|grep -vw docs)"
